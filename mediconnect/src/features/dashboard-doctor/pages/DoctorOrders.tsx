...
export default function DoctorOrders() {
  ...
  const handleCreate = async () => {
    ...
    await createOrder.mutateAsync({ ...form, doctorId:'doc-001', patientName:patient?.name||'', patientAvatar:patient?.avatar||'' });
                  ...
                  <motion.tr key={o.id} initial={{opacity:0}} animate={{opacity:1}} transition={{delay:i*0.03}}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        {o.patientAvatar&&<img src={o.patientAvatar} alt={o.patientName} className="w-7 h-7 rounded-full object-cover bg-primary-50 shrink-0"/>}
