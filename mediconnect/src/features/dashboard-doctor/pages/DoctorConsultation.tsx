    ...
    <>
      ...
      {appt && (
        <div className="card p-4 mb-5 flex items-center gap-4 bg-primary-50 dark:bg-primary-950/20 border-primary-100 dark:border-primary-900">
          <img src={appt.patientAvatar} alt={appt.patientName} className="w-12 h-12 rounded-xl object-cover bg-white shrink-0"/>
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-4">
          ...
          <div className="card p-5 space-y-2">
            ...
            <Link to="/dashboard/doctor/prescriptions" className="w-full btn-outline text-xs flex items-center justify-center gap-2 py-2.5">💊 Emitir receta</Link>
            <Link to="/dashboard/doctor/orders" className="w-full btn-outline text-xs flex items-center justify-center gap-2 py-2.5">🧪 Crear orden médica</Link>
          </div>
