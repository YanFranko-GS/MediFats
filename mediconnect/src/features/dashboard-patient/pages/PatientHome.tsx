...
import { SkeletonRow, Skeleton, Badge } from '../../../shared/components/atoms/index';
...
export default function PatientHome() {
  ...
  return (
    <>
      <Helmet><title>Mi Dashboard – MediConnect</title></Helmet>
      <PageHeader
            ...
            <div className="divide-y divide-surface-100 dark:divide-slate-800">
              {upcoming.map(appt => (
                <div key={appt.id} className="flex items-start gap-3 px-4 py-3 hover:bg-surface-50 dark:hover:bg-slate-800/40 transition-colors">
                  <img src={appt.doctorAvatar} alt={appt.doctorName} className="w-9 h-9 rounded-xl bg-primary-50 object-cover shrink-0 mt-0.5" />
