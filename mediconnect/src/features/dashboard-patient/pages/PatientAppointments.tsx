...
import { SkeletonCard, Badge } from '../../../shared/components/atoms/index';
...
export default function PatientAppointments() {
  ...
  return (
    <>
      <Helmet><title>Mis Citas – MediConnect</title></Helmet>
            ...
            {filtered.map((appt, i) => (
              <motion.div key={appt.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
                ...
                <div className="flex items-start gap-3">
                  <img src={appt.doctorAvatar} alt={appt.doctorName} className="w-12 h-12 rounded-xl object-cover bg-primary-50 shrink-0" />
